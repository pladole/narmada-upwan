...
const COPY = {
  en: {
    ...
    productsTitle: "From biodiversity to healthy produce.",
    productsText:
      "The project will gradually introduce carefully grown produce linked to the values of clean cultivation, biodiversity, and trust. The first planned category is organic vegetables.",
    organicVegTitle: "Organic Vegetables",
    organicVegText:
      "Seasonal vegetables grown with a strong focus on soil health, low-chemical practices, and freshness. Visitors, local families, and interested buyers can join the waitlist to get updates when supply starts.",
    waitlistTitle: "Join the waitlist",
    waitlistText:
      "Share your interest to receive updates on availability, launch timing, and early access to organic vegetable batches.",
  ...
  mr: {
    ...
    productsTitle: "जैवविविधतेतून निरोगी उत्पादनांकडे.",
    productsText:
      "हा प्रकल्प स्वच्छ शेती, जैवविविधता आणि विश्वास या मूल्यांशी जोडलेली उत्पादने टप्प्याटप्प्याने सादर करेल. पहिला नियोजित विभाग म्हणजे सेंद्रिय भाजीपाला.",
    organicVegTitle: "सेंद्रिय भाजीपाला",
    organicVegText:
      "मृदास्वास्थ्य, कमी-रसायन पद्धती आणि ताजेपणा यावर भर देऊन हंगामी भाजीपाला उपलब्ध केला जाईल. पुरवठा सुरू झाल्यावर माहिती मिळवण्यासाठी इच्छुक ग्राहक व अभ्यागत प्रतीक्षा यादीत नोंद करू शकतात.",
    waitlistTitle: "प्रतीक्षा यादीत नाव नोंदवा",
    waitlistText:
      "उपलब्धता, सुरुवातीची वेळ आणि सेंद्रिय भाजीपाल्याच्या पहिल्या बॅचबद्दल माहिती मिळवण्यासाठी आपली रुची नोंदवा.",
    waitlistBtn: "सेंद्रिय भाजीपाला प्रतीक्षा यादी",
      ...
      <main className="mx-auto max-w-7xl px-6 py-16 md:py-20">
        ...
        <section id="products" className="mt-16 rounded-[2rem] bg-white p-8 shadow-sm ring-1 ring-stone-200">
          <div className="grid gap-8 md:grid-cols-[1.05fr_0.95fr]">
            ...
            <div className="rounded-[1.75rem] bg-green-50 p-6 ring-1 ring-green-100">
              <div className="text-lg font-semibold text-green-900">{content.organicVegTitle}</div>
              <p className="mt-3 text-sm leading-7 text-stone-700">{content.organicVegText}</p>
            </div>
          </div>

          <div className="mt-8 grid gap-6 md:grid-cols-[1fr_0.95fr]">
            <div className="rounded-[1.75rem] bg-stone-50 p-6 ring-1 ring-stone-200">
              <div className="text-lg font-semibold text-stone-900">{content.organicVegTitle}</div>
              <div className="mt-4 grid gap-3 text-sm text-stone-700 sm:grid-cols-2">
                <div className="rounded-2xl bg-white p-4 ring-1 ring-stone-200">{language === "en" ? "Leafy vegetables" : "पालेभाज्या"}</div>
                <div className="rounded-2xl bg-white p-4 ring-1 ring-stone-200">{language === "en" ? "Seasonal gourds" : "हंगामी वेलवर्गीय भाज्या"}</div>
                <div className="rounded-2xl bg-white p-4 ring-1 ring-stone-200">{language === "en" ? "Tomato, chilli, brinjal" : "टोमॅटो, मिरची, वांगी"}</div>
                <div className="rounded-2xl bg-white p-4 ring-1 ring-stone-200">{language === "en" ? "Farm-fresh mixed baskets" : "ताज्या मिश्र भाजीपाला टोपल्या"}</div>
              </div>
            </div>
            ...
            <div className="rounded-[1.75rem] bg-green-950 p-6 text-white ring-1 ring-green-900">
              ...
              <form className="mt-5 grid gap-3">
                ...
                <input type="tel" placeholder={language === "en" ? "Phone number" : "फोन नंबर"} className="rounded-xl border border-white/10 bg-white/10 px-4 py-3 text-sm text-white placeholder:text-emerald-100/70 outline-none" />
              ...
              <div className="rounded-[1.75rem] bg-white/10 p-6 ring-1 ring-white/10">
                <div className="space-y-4 text-sm text-stone-100">
                  ...
                  <div>
                    ...
                    <div>
                      {language === "en"
                        ? "Medicinal biodiversity, research, education, landscape restoration, and organic produce"
                        : "औषधी जैवविविधता, संशोधन, शिक्षण, पर्यावरणीय पुनर्स्थापना आणि सेंद्रिय उत्पादन"}
                    </div>
                  </div>
                </div>
              </div>
