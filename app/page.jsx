...
const COPY = {
  en: {
    ...
    heroText: "Narmada Upwan and Sanshodhan Kendra is being developed in memory of Narmadabai Kisanrao Ladole — a teacher with a lifelong passion for education and farming — as a medicinal biodiversity, research, and educational park in the Chikhaldara–Melghat landscape.",
    ...
    highlights: [
      ...
      { title: "Living Legacy", text: "Developed in memory of Narmadabai Kisanrao Ladole — a teacher, farmer, and lifelong learner." },
    ...
    aboutP1: "The project is located at Bhilkheda, near Anjangaon Surji, within the broader Chikhaldara–Melghat region of Maharashtra. It is envisioned as an integrated landscape for medicinal plant conservation, ecological restoration, nursery development, field learning, and public awareness.",
    aboutP2: "Built around biodiversity, education, and research, the park brings together native medicinal species, interpretation zones, training spaces, and visitor access in a way that respects both ecology and local context.",
    snapshot: "Project snapshot",
    legacyKicker: "Legacy",
    legacyTitle: "In memory of Narmadabai Kisanrao Ladole.",
    legacyP1: "Born in Lohi, Yavatmal district, she fought to continue her education when circumstances pushed against it. She worked in the fields to support her studies, later became a primary school teacher, and remained deeply connected to farming throughout her life.",
    legacyP2: "This park reflects the values she lived by: discipline, self-reliance, love for land, and commitment to learning. It is being developed as a living tribute to her journey and to the future she believed in.",
    parkKicker: "The Park",
    parkTitle: "Master layout built for ecology, learning, and continuity.",
    parkText: "The 25-acre plan balances conservation habitat, themed medicinal gardens, nursery systems, public access, and research spaces instead of overbuilding the site.",
    researchKicker: "Research and learning",
    researchTitle: "Built for field-based knowledge.",
    researchText: "The park is planned as more than a conservation site. It is intended to support training programs, school visits, farmer learning, nursery-based propagation, documentation of medicinal plants, and future research collaborations.",
    whyKicker: "Why it matters",
    whyP1: "Medicinal plant diversity is under pressure from habitat loss, fragmented landscapes, and fading traditional knowledge. This project creates a structured place where conservation, education, and community relevance can meet.",
    whyP2: "By combining nursery capacity, themed interpretation, biodiversity restoration, and access for learners, the park can serve as a credible platform for long-term ecological and educational value.",
    galleryKicker: "Gallery",
    galleryTitle: "Landscape, progress, and memory.",
    galleryText: "Replace these placeholders with your farm, plantation, family, and project progress photos.",
    visitKicker: "Visit",
    visitTitle: "Find the project site.",
    openMaps: "Open in Google Maps",
    contactKicker: "Contact",
    contactTitle: "Build the next chapter of the park.",
    contactText: "For collaboration, nursery planning, biodiversity development, educational visits, or project discussions, reach out through the official website domain and contact channels.",
    ...
    cards: {
      projectName: "Project Name", location: "Location", coordinates: "Coordinates", nearestTown: "Nearest Town",
      projectType: "Project Type", domain: "Domain", born: "Born", passedAway: "Passed Away",
      placeOfBirth: "Place of Birth", profession: "Profession", passions: "Life’s Passions",
      parkLegacy: "Legacy in the Park", address: "Address", region: "Region", website: "Website", focus: "Focus"
    }
  },
  mr: {
    ...
    galleryText: "तुमच्या शेत, लागवड, कुटुंब आणि प्रकल्प प्रगतीची छायाचित्रे येथे बदला.",
    visitKicker: "भेट",
    ...
    cards: {
      projectName: "प्रकल्प नाव", location: "स्थान", coordinates: "निर्देशांक", nearestTown: "जवळचे शहर",
      projectType: "प्रकल्प प्रकार", domain: "डोमेन", born: "जन्म", passedAway: "निधन",
      placeOfBirth: "जन्मगाव", profession: "व्यवसाय", passions: "आवडी",
      parkLegacy: "उद्यानातील वारसा", address: "पत्ता", region: "परिसर", website: "संकेतस्थळ", focus: "केंद्रबिंदू"
    }
  }
};
...
const GALLERY = ["/gallery1.jpg", "/gallery2.jpg", "/gallery3.jpg", "/gallery4.jpg", "/gallery5.jpg", "/gallery6.jpg"];
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-green-950 via-green-900 to-emerald-800 text-white">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-6 py-20 md:grid-cols-2 md:items-center md:py-28">
          <div>
            ...
            <h1 className="max-w-3xl text-4xl font-semibold leading-tight md:text-6xl">{content.heroTitle}</h1>
            <p className="mt-6 max-w-2xl text-base leading-7 text-emerald-50 md:text-lg">{content.heroText}</p>
            <div className="mt-8 flex flex-wrap gap-4">
              <a href="#about" className="rounded-2xl bg-white px-5 py-3 text-sm font-semibold text-green-900 shadow-lg shadow-black/10 transition hover:-translate-y-0.5">{content.explore}</a>
              <a href="#visit" className="rounded-2xl border border-white/25 px-5 py-3 text-sm font-semibold text-white transition hover:bg-white/10">{content.visitInfo}</a>
              <a href="#contact" className="rounded-2xl border border-emerald-300/30 bg-emerald-400/10 px-5 py-3 text-sm font-semibold text-emerald-50 transition hover:bg-emerald-400/20">{content.support}</a>
            </div>
          </div>
      ...
      <main className="mx-auto max-w-7xl px-6 py-16 md:py-20">
        <section id="about" className="grid gap-8 md:grid-cols-[1.1fr_0.9fr]">
          <div className="rounded-[2rem] bg-white p-8 shadow-sm ring-1 ring-stone-200">
            ...
            <h2 className="mt-3 text-3xl font-semibold tracking-tight text-stone-900 md:text-4xl">{content.aboutTitle}</h2>
          ...
          <div className="rounded-[2rem] bg-green-50 p-8 ring-1 ring-green-100">
            <div className="text-sm font-semibold uppercase tracking-[0.22em] text-green-700">{content.snapshot}</div>
        ...
        <section id="park" className="mt-16 rounded-[2rem] bg-white p-8 shadow-sm ring-1 ring-stone-200">
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-semibold tracking-tight text-stone-900 md:text-4xl">{content.parkTitle}</h2>
            </div>
        ...
        <section id="research" className="mt-16 grid gap-8 md:grid-cols-2">
          <div className="rounded-[2rem] bg-green-950 p-8 text-white shadow-sm">
            ...
            <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">{content.researchTitle}</h2>
            <p className="mt-5 text-base leading-8 text-emerald-50">{content.researchText}</p>
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              {["Medicinal plant nursery development","Species documentation and labeling","Farmer and student exposure visits","Ethnomedicine interpretation","Conservation-led field trials","Long-term landscape stewardship"].map((item) => (
                <div key={item} className="rounded-2xl bg-white/10 p-4 text-sm text-emerald-50 ring-1 ring-white/10">{item}</div>
              ))}
            </div>
          </div>
        ...
        <section id="visit" className="mt-16 grid gap-8 md:grid-cols-[1fr_1fr]">
          <div className="rounded-[2rem] bg-white p-8 shadow-sm ring-1 ring-stone-200">
            ...
            <div className="mt-6 space-y-4 text-base leading-8 text-stone-700">
              <p><span className="font-semibold text-stone-900">{content.cards.address}:</span> {language === "en" ? "Bhilkheda, Chikhaldara, Amravati, Maharashtra, India" : "भिलखेडा, चिखलदरा, अमरावती, महाराष्ट्र, भारत"}</p>
              <p><span className="font-semibold text-stone-900">{content.cards.coordinates}:</span> 21.242359° N, 77.283859° E</p>
              <p><span className="font-semibold text-stone-900">{content.cards.nearestTown}:</span> {language === "en" ? "Anjangaon Surji (12 km)" : "अंजनगाव सुर्जी (१२ कि.मी.)"}</p>
              <p><span className="font-semibold text-stone-900">{content.cards.region}:</span> {language === "en" ? "Chikhaldara–Melghat landscape" : "चिखलदरा–मेलघाट परिसर"}</p>
            </div>
          ...
          <div className="rounded-[2rem] bg-stone-100 p-3 ring-1 ring-stone-200">
            <iframe title="Narmada Upwan location" src="https://www.google.com/maps?q=21.242359,77.283859&z=13&output=embed" className="h-[380px] w-full rounded-[1.5rem] border-0" loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
          </div>
        </section>
        ...
        <section id="contact" className="mt-16 rounded-[2rem] bg-gradient-to-br from-stone-900 to-stone-800 p-8 text-white shadow-sm">
          <div className="grid gap-8 md:grid-cols-[1.2fr_0.8fr]">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">{content.contactTitle}</h2>
            ...
            <div className="grid gap-4">
              <div className="rounded-[1.75rem] bg-white/10 p-6 ring-1 ring-white/10">
                <div className="space-y-4 text-sm text-stone-100">
                  <div><div className="font-semibold text-emerald-200">{content.cards.website}</div><div>narmadaupwan.org</div></div>
                  <div><div className="font-semibold text-emerald-200">{content.cards.location}</div><div>{language === "en" ? "Bhilkheda, Chikhaldara, Maharashtra" : "भिलखेडा, चिखलदरा, महाराष्ट्र"}</div></div>
                  <div><div className="font-semibold text-emerald-200">{content.cards.focus}</div><div>{language === "en" ? "Medicinal biodiversity, research, education, and landscape restoration" : "औषधी जैवविविधता, संशोधन, शिक्षण आणि पर्यावरणीय पुनर्स्थापना"}</div></div>
                </div>
              </div>
